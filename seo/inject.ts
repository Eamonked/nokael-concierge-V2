    ...
    <article style="max-width:800px;margin:0 auto;padding:20px;font-family:sans-serif;line-height:1.6;color:#1a1a1a;">
      <header style="border-bottom:2px solid #00ff00;padding-bottom:20px;margin-bottom:30px;">
        ...
        <div style="margin-top:20px;">
          <a href="tel:+971544324600" style="background:#000;color:#fff;padding:12px 24px;text-decoration:none;border-radius:8px;font-weight:bold;margin-right:10px;display:inline-block;">Call: +971 54 432 4600</a>
          <a href="https://wa.me/971544324600" style="background:#00ff00;color:#000;padding:12px 24px;text-decoration:none;border-radius:8px;font-weight:bold;display:inline-block;">WhatsApp Dispatch</a>
        </div>
      </header>
