...
export const DISPLAY_PHONE = import.meta.env.VITE_DISPLAY_PHONE || '+971509710446';
...
// PRICING CONSTANTS
export const PRICE_TIER_NEXT_MORNING = import.meta.env.VITE_PRICE_TIER_NEXT_MORNING || '230';
export const PRICE_TIER_SAME_DAY = import.meta.env.VITE_PRICE_TIER_SAME_DAY || '230';
export const PRICE_TIER_DEDICATED = import.meta.env.VITE_PRICE_TIER_DEDICATED || '380';
